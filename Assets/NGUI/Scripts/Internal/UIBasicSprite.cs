...
public abstract class UIBasicSprite : UIWidget
{
	...
	override public int minHeight
	{
		...
		protected virtual int GetAtlasWidth()
		{
			return 0;
		}
		/// <summary>
		...
		protected virtual int GetAtlasHeight()
		{
			return 0;
		}
		#endif
...
#region Fill Functions
	...
	void TiledFill (BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
	{
		...
		#region NGUI_CHANGE_FOR_N3DS
		#if UNITY_N3DS
		int w = this.GetAtlasWidth();
		int h = this.GetAtlasHeight();
		if (w == 0) { w = tex.width; }
		if (h == 0) { h = tex.height; }
		Vector2 size = new Vector2(mInnerUV.width * w, mInnerUV.height * h);
		#else
