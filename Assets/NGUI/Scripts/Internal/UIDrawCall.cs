...
public class UIDrawCall : MonoBehaviour
{
	...
	void CreateMaterial ()
	{
		...
		string shaderName = (mShader != null) ? mShader.name :
			((mMaterial != null) ? mMaterial.shader.name : "Sprites/Default");
		// Figure out the normal shader's name
		if (shaderName.Equals("Unlit/Transparent Colored") ||
			shaderName.Equals("Unlit/Premultiplied Colored") ||
			shaderName.StartsWith("Custom/Toydea/"))
		{
