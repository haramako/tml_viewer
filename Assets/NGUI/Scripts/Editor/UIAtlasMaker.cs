...
public class UIAtlasMaker : EditorWindow
{
	...
	static public bool UpdateTexture (UIAtlas atlas, List<SpriteEntry> sprites)
	{
		...
		{
			//NGUIHook.AfterAtlasMakerPackTextures(tex);
	...
	// atlasの全体更新
	public static void UpdateAtlasAll (UIAtlas atlas, List<Texture> textures){
		var window = UIAtlasMaker.GetWindow (typeof(UIAtlasMaker));
		window.Show ();
		NGUISettings.atlas = atlas;
		UIAtlasMaker.instance.UpdateAtlas (textures, false);
	}
