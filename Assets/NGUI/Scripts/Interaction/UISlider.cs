...
public class UISlider : UIProgressBar
{
	...
	{
#if FAKE_RIGIDBODY
		GameObject bg = (mBG != null && (mBG.GetComponent<BoxCollider>() != null )) ? mBG.gameObject : gameObject;
		UIEventListener bgl = UIEventListener.Get(bg);
		bgl.onPress += OnPressBackground;
		bgl.onDrag += OnDragBackground;

		if (thumb != null && (thumb.GetComponent<BoxCollider>() != null ) && (mFG == null || thumb != mFG.cachedTransform))
#else
